...
1. You must [create a development store](https://help.shopify.com/ennp/partners/dashboard/development-stores#create-a-development-store) if you don’t have one.
